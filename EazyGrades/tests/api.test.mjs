...
async function fixture(t,overrides={}){
 ...
 const app=createApp({dataDir:dir,dbPath:':memory:',appUrl:origin,stripe,webhookSecret:secret,priceIds:{basic:'price_basic',pro:'price_pro',semester:'price_semester'},checkoutEnabled:true,supportEmail:'support@example.com',rateLimits:false,now:()=>time,...overrides});
